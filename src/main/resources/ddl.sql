...
update restaurante set endereco_bairro="Encruzilhada", endereco_cep="52041210", endereco_logradouro="Rua Inacio Galvao dos Santos", endereco_numero="196", endereco_cidade_id = 6 where id = 1
